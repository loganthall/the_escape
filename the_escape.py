...
while True:
    ...
    print(r"""
 ______  __ __    ___        ___  _____   __   ____  ____   ___
|      ||  |  |  /  _]      /  _]/ ___/  /  ] /    ||    \ /  _]
|      ||  |  | /  [_      /  [_(   \   /  / |  o  ||  o  )  [_
|_|  |_||  _  ||    _]    |    _]\__ \ /  /  |     ||   _/    _]
  |  |  |  |  ||   [_     |   [_ /  \ /   \_ |  _  ||  | |   [_
  |  |  |  |  ||     |    |     |\    \     ||  |  ||  | |     |
  |__|  |__|__||_____|    |_____| \___|\____||__|__||__| |_____|""")
    ...
    while iter >= 0:
        ...
        if iter > 10:  # after 10 successful choices, the user makes it out alive
            print("\nYou finally come to a door that appears to be barred shut. \nFortunately, there is an open window above it, just big enough \nfor your body to slip through. You climb up into the windows \nwith all your remaining strength, and fall to the other side, \nfeeling the warmth of daylight hit your face. \nThe nightmare is over...you have survived.")
        ...
        if movement_choice == False:  # False is returned when a secret word is entered
            play_again = randomizer.play_again()
            if play_again == True:
                break
            ...
            if movement_choice == "\nYou decide to turn around and face the one that \nbrought you here. Not only are they larger than you, their \neyes somehow glow black with darkess.\n":
