...
def randomize_movement():  # function that randomizes the movement options
    ...
    if user_choice == "1":
        ...
        print("\nYou spoke the secret word and the world around you seems to materialize into something more familiar. You slowly fade in and out of consciousness, and when you finally wake up you are back home in your bed. It was all a bad dream.")
        return False
